...
export const exercisePresets: ExercisePreset[] = [
  ...
  ['preset-squat', 'スクワット', 'quadriceps', 'barbell'],
  ['preset-leg-press', 'レッグプレス', 'quadriceps', 'machine'],
  ['preset-leg-curl', 'レッグカール', 'hamstrings', 'machine'],
  ['preset-shoulder-press', 'ショルダープレス', 'frontDelts', 'dumbbell'],
  ['preset-side-raise', 'サイドレイズ', 'sideDelts', 'dumbbell'],
  ['preset-face-pull', 'フェイスプル', 'rearDelts', 'cable'],
